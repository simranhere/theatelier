...
export default function ProfileTailor() {
  ...
  const doSaveOrUpdate = async (e: React.FormEvent) => {
    ...
    let url = isEditing
      ? "https://theatelier-wheat.vercel.app/tailor/update-tailor-profile"
      : "https://theatelier-wheat.vercel.app/tailor/save-tailor-profile";
  ...
  async function doFind() {
    ...
    try {
      let resp = await axios.post("https://theatelier-wheat.vercel.app/tailor/find-tailor", { emailid: form.emailid });
      if (resp.data.status) {
  ...
  async function doExtractAadhaar(file: File) {
    ...
    try {
      let resp = await axios.post("https://theatelier-wheat.vercel.app/tailor/extract-aadhaar", fd, {
